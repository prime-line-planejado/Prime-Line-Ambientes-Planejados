            ...
            <table className="w-full">
              ...
              <tbody>
                {(leads as Lead[]).map((lead, i) => {
                  const waUrl = `https://wa.me/5531971916235?text=${encodeURIComponent(`Olá ${lead.nome}, tudo bem? Vi que você se cadastrou no site da Prime Line Ambientes Planejados. Posso te ajudar a agendar uma visita técnica gratuita?`)}`
                  return (
                    <tr
                      key={lead.id}
