...
const jsonLd = {
  ...
  review: [
    {
      '@type': 'Review',
      author: { '@type': 'Person', name: 'Joacmedeiros Medeiros' },
      reviewRating: { '@type': 'Rating', ratingValue: '5', bestRating: '5' },
      reviewBody: 'Desde o atendimento até o término. Super recomendo.',
    },
    {
      '@type': 'Review',
      author: { '@type': 'Person', name: 'Fanny Santana' },
      reviewRating: { '@type': 'Rating', ratingValue: '5', bestRating: '5' },
      reviewBody: 'Empresa maravilhosa, quando fui atendida eles foram bem receptivos e me mostraram um projeto maravilhoso, mas quando entregaram, eu fiquei abismada, parabéns pela equipe, obrigado Prime Line, sucesso!',
    },
  ],
}
